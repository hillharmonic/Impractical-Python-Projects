...
# ensuring "a & i are both included"
dict_file.append('a')
dict_file.append('i')
...
def find_anagrams(name, word_list):
    """Reads name & dictionary file & displays all anagrams in the name."""
...
def process_choice(name):
    """Checks users choice for validity, returns choice and leftover letters."""
    while True:
...
def main():
    ...
    while running:
        ...
        if len(temp_phrase) < limit:
            print("Legnth of anagram phrase = {}".format(len(temp_phrase)))
